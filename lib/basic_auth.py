...
class basic_auther:
    ...
    def build_credentials(self, config_dic):
        ...
        # Python 3: base64 expects bytes, returns bytes
        msg_bytes = msg.encode('utf-8')
        b64 = base64.encodebytes(msg_bytes).decode('ascii')
        b64 = b64.replace('\n', '').replace('\r', '')
        return b64
    ...
    def proxy_basic_authentication(self, connection):
        """
        Perform proxy basic authentication.
        """
    ...
    def www_basic_authentication(self, connection):
        """
        Perform www basic authentication.
        """
        connection.logger.log('*** Basic authorization in progress...\n')
        connection.close_rserver()
        connection.connect_rserver()
